package top.likamao.likaojbackendquesitonservice.controller;
...
import top.likamao.likaojbackendmodel.model.dto.question.*;
...
import top.likamao.likaojbackendmodel.model.vo.QuestionVO;
...
public class QuestionController {
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        if (!user.getId().equals(question.getUserId()) && !userFeignClient.isAdmin(user)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR, "无权限查看该资源");
        }
